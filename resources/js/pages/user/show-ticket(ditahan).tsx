...
const ShowTicket: React.FC = () => {
  ...
  const [messages] = useState<Message[]>([
    { id: "m1", author: "Pelayanan", role: "staff", timeAgo: "10 menit yang lalu", text: "Mohon bersabar ya, sistem kami sedang maintenance/perbaikan. Estimasi 1x24 jam." },
  ...
  const steps = [
    ...
    { key: "assigned",    label: "Ditugaskan ke Staf Jaringan",    time: "02/11/2025 10:30", state: "current", icon: "fa-clock"},
    { key: "working",     label: "Dalam Proses",                   time: "02/11/2025 11:15", icon: "fa-clock" },
    { key: "finished",    label: "Selesai",                        time: "02/11/2025 13:45", icon: "fa-clock" },
    { key: "confirmation",label: "Menunggu Konfirmasi Pengguna",   note: "Diterima/Ditolak", icon: "fa-clock" },
  ...
  const isOnHold = ticket.status === "ditahan";
  ...
  const shouldShowFullReplyForm = !isClosed && !isOnHold && messages.length === 0;
        ...
        <div className={`${container} py-8`}>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
            ...
            <section className="md:col-span-8 space-y-6">
              ...
              {/* Banner kondisi */}
              {isOnHold && (
                <div className="rounded-lg bg-amber-100 text-amber-900 ring-1 ring-amber-200 px-4 py-3">
                  <div className="font-semibold flex items-center gap-2">
                    <i className="fas fa-pause-circle" />
                    <span>Tiket ditahan:</span>
                  </div>
                  <p className="mt-1 text-sm">
                    Terima kasih telah menghubungi kami! Tiket Anda telah ditangguhkan sementara karena kami sedang mengumpulkan informasi tambahan
                    untuk memberikan bantuan terbaik. Kami menghargai kesabaran Anda dan akan memprioritaskan penyelesaian masalah Anda sesegera mungkin.
                  </p>
                </div>
              )}
              ...
              {/* Reply hanya jika BUKAN ditahan & BUKAN ditutup */}
              {!isOnHold && !isClosed && (
                <>
